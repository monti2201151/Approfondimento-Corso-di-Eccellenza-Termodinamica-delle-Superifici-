...
def plot_wulff_shape(result, show_normals=True, show_center=True,
    ...
    legend_handles = [
        Patch(facecolor=colors[lab], edgecolor="k",
              label=f"{lab}  γ={label_to_gamma[lab]:.2f}")
...
# =======================================================================
# MAIN // VALORI PER IL FERRO; CON INDICI DI MILLER FINO A 3
# =======================================================================

if __name__ == "__main__":
    families = [
        MillerFamily(hkl=(1, 1, 0), gamma=2.45),
        MillerFamily(hkl=(1, 0, 0), gamma=2.50),
        MillerFamily(hkl=(2, 1, 0), gamma=2.57),
        MillerFamily(hkl=(2, 1, 1), gamma=2.61),
        MillerFamily(hkl=(3, 1, 1), gamma=2.63),
        MillerFamily(hkl=(2, 2, 1), gamma=2.66),
        MillerFamily(hkl=(3, 3, 2), gamma=2.68),
        MillerFamily(hkl=(1, 1, 1), gamma=2.73)
    ...
    fig, ax, check = plot_wulff_shape(
        ...
        title="The Wulff shape of α-Fe generated with surface energies for facets up to a max Miller index of 3.",
    )
...
# =======================================================================
# MAIN // VALORI PER IL FERRO; CON INDICI DI MILLER FINO A 1
# =======================================================================
...
if __name__ == "__main__":
    ...
    fig, ax, check = plot_wulff_shape(
        ...
        show_center=True,
        show_reference_sphere=False,
        title="The Wulff shape of α-Fe generated with surface energies for facets up to a max Miller index of 1.",
    )
