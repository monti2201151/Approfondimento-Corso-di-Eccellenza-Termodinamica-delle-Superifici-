...
# =======================================================================
# MAIN // VALORI PER L'oro; CON INDICI DI MILLER FINO A 3
# =======================================================================

if __name__ == "__main__":
    families = [
        MillerFamily(hkl=(1, 1, 0), gamma=0.909),
        MillerFamily(hkl=(1, 0, 0), gamma=0.861),
        MillerFamily(hkl=(2, 1, 0), gamma=0.906),
        MillerFamily(hkl=(2, 1, 1), gamma=0.822),
        MillerFamily(hkl=(3, 1, 1), gamma=0.870),
        MillerFamily(hkl=(2, 2, 1), gamma=0.780),
        MillerFamily(hkl=(3, 3, 2), gamma=0.748),
        MillerFamily(hkl=(1, 1, 1), gamma=0.710),
        MillerFamily(hkl=(3, 2, 2), gamma=0.748),
        MillerFamily(hkl=(3, 3, 1), gamma=0.831),
        MillerFamily(hkl=(3, 2, 1), gamma=0.848),
        MillerFamily(hkl=(3, 1, 0), gamma=0.906),
        MillerFamily(hkl=(3, 2, 0), gamma=0.913)
    ]
    result = build_wulff_polyhedron(families, k=1.0)

    print(f'Cristallo di ORO (mp-81):')
    ...
    fig, ax, check = plot_wulff_shape(
        ...
        title="The Wulff shape of gold (mp-81) generated with surface energies for facets up to a max Miller index of 3.",
    )
